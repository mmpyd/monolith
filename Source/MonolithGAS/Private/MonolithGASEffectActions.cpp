...
// UE 5.5 has no dedicated CancelAbilityTags GE component; it was added in a later release.
...
#endif // UE 5.5 has no UCancelAbilityTagsGameplayEffectComponent (cancel_abilities unreachable there)
